...
Answer (You may write your answer in either Korean or English): 'show_usage'메소드는 모든 명령어에서 사용되지만 'execute'메소드는 각 명령어마다 다른 기능을 수행해야 하니 각 클래스에서 구현되어야 하기 때문이다.
...
Answer (You may write your answer in either Korean or English): 'current_path' 변수가 클래스 변수로 선언되었기에 이를 업데이트하는 메소드는 클래스 수준에서 실행되어야 한다.
